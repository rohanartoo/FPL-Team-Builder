...
import { ComparePlayerHeader } from "./compare/ComparePlayerHeader";
import { FormTrajectoryChart } from "./compare/FormTrajectoryChart";
import { FixturesComparison } from "./compare/FixturesComparison";
    ...
    <div className="max-w-3xl mx-auto">
      ...
      {playerA && playerB && (
        <>
          ...
          {/* Section: Form Trajectory */}
          <>
            <SectionHeader title="Form Trajectory (Last 10 GWs)" />
            <FormTrajectoryChart
              playerA={playerA}
              playerB={playerB}
